...
export class NestedCognitoStack extends NestedStack {
    ...
    constructor(scope: Construct, id: string, props?: NestedStackProps) {
        ...
        this.userPool = new UserPool(scope, `${ id }-cognito-user-pool`, {
        ...
        this.userPool.addClient(`${ id }-pool-client`, {
        ...
        new PolicyStatement({
            actions: ['cognito-idp:AdminCreateUser', 'cognito-idp:AdminUpdateUserAttributes', 'cognito-idp:AdminGetUser', 'cognito-idp:AdminDisableUser', 'cognito-idp:AdminEnableUser'],
